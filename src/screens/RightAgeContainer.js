  ...
  return (
    <div className="section__rightage row__rightage">
      <div className="container-fluid">
        <div className="row">
          <div className="col-lg-3 offset-lg-7 col-md-4 offset-md-7 col-sm-6 offset-sm-6 col-xs-6 offset-xs-6">
        ...
        <div className="row">
          ...
          <div className="row">
            <div className="col-lg-3 offset-lg-7 col-md-3 offset-md-7 col-sm-6 offset-sm-6 col-xs-6 offset-xs-6">
